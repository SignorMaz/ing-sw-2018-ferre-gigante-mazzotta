...
public class WindowPattern1 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern1() {
        ...
        map.put(new Position(4, 0), new WindowCell(Color.GREEN, 0));

        map.put(new Position(0, 1), new WindowCell(Color.BLANK, 0));
        map.put(new Position(1, 1), new WindowCell(Color.BLANK, 0));
        map.put(new Position(2, 1), new WindowCell(Color.BLANK, 6));
        ...
        map.put(new Position(1, 2), new WindowCell(Color.BLANK, 3));
        ...
        map.put(new Position(2, 3), new WindowCell(Color.BLANK, 1));
