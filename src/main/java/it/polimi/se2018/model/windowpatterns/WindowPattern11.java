...
public class WindowPattern11 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern11() {
        ...
        map.put(new Position(0, 1), new WindowCell(Color.BLANK, 4));
        ...
        map.put(new Position(1, 2), new WindowCell(Color.BLANK, 1));
        ...
        map.put(new Position(2, 3), new WindowCell(Color.BLANK, 6));
