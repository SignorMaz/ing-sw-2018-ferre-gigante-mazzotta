...
public class WindowPattern15 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern15() {
        ...
        map.put(new Position(3, 2), new WindowCell(Color.BLANK, 4));
        ...
        map.put(new Position(2, 3), new WindowCell(Color.BLANK, 2));
