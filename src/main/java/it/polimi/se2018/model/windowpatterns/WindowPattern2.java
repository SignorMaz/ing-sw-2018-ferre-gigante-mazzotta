...
public class WindowPattern2 implements WindowPattern {
    ...
    public WindowPattern2() {
        ...
        map.put(new Position(1, 2), new WindowCell(Color.YELLOW, 0));
