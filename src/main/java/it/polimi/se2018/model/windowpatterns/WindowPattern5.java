...
public class WindowPattern5 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern5() {
        map.put(new Position(0, 0), new WindowCell(Color.BLANK, 5));
        map.put(new Position(1, 0), new WindowCell(Color.GREEN, 0));
        map.put(new Position(2, 0), new WindowCell(Color.BLUE, 0));
        map.put(new Position(3, 0), new WindowCell(Color.PURPLE, 0));
        map.put(new Position(4, 0), new WindowCell(Color.BLANK, 2));
        ...
        map.put(new Position(4, 1), new WindowCell(Color.YELLOW, 0));

        map.put(new Position(0, 2), new WindowCell(Color.YELLOW, 0));
        map.put(new Position(1, 2), new WindowCell(Color.BLANK, 0));
        map.put(new Position(2, 2), new WindowCell(Color.BLANK, 6));
        map.put(new Position(3, 2), new WindowCell(Color.BLANK, 0));
