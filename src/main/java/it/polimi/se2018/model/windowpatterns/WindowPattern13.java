...
public class WindowPattern13 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern13() {
        map.put(new Position(0, 0), new WindowCell(Color.BLANK, 3));
        ...
        map.put(new Position(4, 2), new WindowCell(Color.RED, 0));
        ...
        map.put(new Position(3, 3), new WindowCell(Color.RED, 0));
        map.put(new Position(4, 3), new WindowCell(Color.BLANK, 6));
    }
