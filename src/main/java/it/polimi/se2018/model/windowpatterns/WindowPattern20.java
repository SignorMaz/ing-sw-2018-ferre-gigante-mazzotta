...
public class WindowPattern20 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern20() {
        map.put(new Position(0, 0), new WindowCell(Color.YELLOW, 0));
        map.put(new Position(1, 0), new WindowCell(Color.BLANK, 0));
        map.put(new Position(2, 0), new WindowCell(Color.BLANK, 2));
