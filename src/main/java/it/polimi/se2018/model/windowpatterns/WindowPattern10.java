...
public class WindowPattern10 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern10() {
        ...
        map.put(new Position(0, 2), new WindowCell(Color.RED, 0));
        ...
        map.put(new Position(3, 3), new WindowCell(Color.BLANK, 4));
