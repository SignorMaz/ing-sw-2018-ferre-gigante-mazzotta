...
public class WindowPattern18 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern18() {
        map.put(new Position(0, 0), new WindowCell(Color.BLANK, 0));
        map.put(new Position(1, 0), new WindowCell(Color.BLANK, 4));
        map.put(new Position(2, 0), new WindowCell(Color.BLANK, 0));
        map.put(new Position(3, 0), new WindowCell(Color.YELLOW, 0));
        map.put(new Position(4, 0), new WindowCell(Color.BLANK, 6));

        map.put(new Position(0, 1), new WindowCell(Color.RED, 0));
        ...
        map.put(new Position(2, 2), new WindowCell(Color.RED, 0));
        map.put(new Position(3, 2), new WindowCell(Color.PURPLE, 0));
        map.put(new Position(4, 2), new WindowCell(Color.BLANK, 1));

        map.put(new Position(0, 3), new WindowCell(Color.BLUE, 0));
        map.put(new Position(1, 3), new WindowCell(Color.YELLOW, 0));
