...
public class WindowPattern4 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern4() {
        ...
        map.put(new Position(0, 1), new WindowCell(Color.GREEN, 0));
        ...
        map.put(new Position(4, 1), new WindowCell(Color.BLANK, 4));
        ...
        map.put(new Position(0, 3), new WindowCell(Color.BLANK, 2));
        ...
        map.put(new Position(4, 3), new WindowCell(Color.YELLOW, 0));
    }
