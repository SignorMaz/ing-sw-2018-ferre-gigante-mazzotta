...
public class WindowPattern3 implements WindowPattern {

    private final Map<Position, WindowCell> map = new HashMap<>();

    public WindowPattern3() {
        ...
        map.put(new Position(4, 0), new WindowCell(Color.YELLOW, 0));

        map.put(new Position(0, 1), new WindowCell(Color.BLANK, 0));
        map.put(new Position(1, 1), new WindowCell(Color.BLANK, 3));
        map.put(new Position(2, 1), new WindowCell(Color.BLUE, 5));
        ...
        map.put(new Position(3, 2), new WindowCell(Color.BLANK, 2));
        ...
        map.put(new Position(4, 3), new WindowCell(Color.GREEN, 0));
    }
