...
public class PublicObjectiveCard2Test {
    ...
    public void testGetPoints() {
        ...
        WindowPattern windowPattern = new PublicObjectiveCard2Test.WindowPatternTest();
        ...
        windowFrame.placeDiceUnrestricted(new Dice(Color.BLUE, 5), new Position(1, 1));
        ...
        windowFrame.placeDiceUnrestricted(new Dice(Color.PURPLE, 5), new Position(3, 1));
        ...
        windowFrame.placeDiceUnrestricted(new Dice(Color.PURPLE, 6), new Position(0, 1));
        windowFrame.placeDiceUnrestricted(new Dice(Color.YELLOW, 6), new Position(3, 4));
        assertEquals(5, new PublicObjectiveCard2().getPoints(windowFrame));
    }
}
