...
import it.polimi.se2018.model.objectivecards.PublicObjectiveCard6;
...
public class PublicObjectiveCard6Test {
    ...
    public void testGetPoints() {
        ...
        WindowPattern windowPattern = new PublicObjectiveCard6Test.WindowPatternTest();
        WindowFrame windowFrame = new WindowFrame(windowPattern);

        assertEquals(0, new PublicObjectiveCard6().getPoints(windowFrame));
        ...
        assertEquals(2, new PublicObjectiveCard6().getPoints(windowFrame));
        ...
        assertEquals(4, new PublicObjectiveCard6().getPoints(windowFrame));
