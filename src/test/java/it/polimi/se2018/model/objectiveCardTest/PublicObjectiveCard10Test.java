...
public class PublicObjectiveCard10Test {
    ...
    public void testGetPoints() {
        ...
        windowFrame.placeDiceUnrestricted(new Dice(Color.RED), new Position(1, 1));
        windowFrame.placeDiceUnrestricted(new Dice(Color.YELLOW), new Position(2, 2));
        windowFrame.placeDiceUnrestricted(new Dice(Color.GREEN), new Position(3, 3));
        assertEquals(0, new PublicObjectiveCard10().getPoints(windowFrame));

        windowFrame.placeDiceUnrestricted(new Dice(Color.PURPLE), new Position(0, 4));
        ...
        windowFrame.placeDiceUnrestricted(new Dice(Color.BLUE), new Position(3, 2));
        windowFrame.placeDiceUnrestricted(new Dice(Color.YELLOW), new Position(2, 4));
        windowFrame.placeDiceUnrestricted(new Dice(Color.GREEN), new Position(3, 4));
        assertEquals(4, new PublicObjectiveCard10().getPoints(windowFrame));
    }
}