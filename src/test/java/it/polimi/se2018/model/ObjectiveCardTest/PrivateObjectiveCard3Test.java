...
import it.polimi.se2018.model.objectivecards.PrivateObjectiveCard3;
...
public class PrivateObjectiveCard3Test {
    ...
    public void testGetPoints() {
        ToolCard toolCard = new PrivateObjectiveCard3Test.PermissiveToolCard();

        WindowPattern windowPattern = new PrivateObjectiveCard3Test.WindowPatternTest();
        WindowFrame windowFrame = new WindowFrame(windowPattern);

        assertEquals(0, new PrivateObjectiveCard3().getPoints(windowFrame));
        ...
        assertEquals(7, new PrivateObjectiveCard3().getPoints(windowFrame));
        ...
        assertEquals(12, new PrivateObjectiveCard3().getPoints(windowFrame));
        ...
        assertEquals(18, new PrivateObjectiveCard3().getPoints(windowFrame));
    }
}
